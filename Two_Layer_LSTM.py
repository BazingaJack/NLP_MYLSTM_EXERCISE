...
class TextLSTM(nn.Module):
    def __init__(self):
        ...
        self.W_i_i2 = nn.Linear(n_hidden,n_hidden,bias=False)
        ...
        self.W_i_f2 = nn.Linear(n_hidden,n_hidden,bias=False)
        ...
        self.W_i_g2 = nn.Linear(n_hidden,n_hidden,bias=False)
        ...
        self.W_i_o2 = nn.Linear(n_hidden,n_hidden,bias=False)
    ...
    def forward(self, X):
        ...
        for X_t2 in X2:
            ...
            h_t2_1 = h_t2
            c_t2_1 = c_t2
        outputs = o_t2[-1] # [batch_size, num_directions(=1) * n_hidden]
